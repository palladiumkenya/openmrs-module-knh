 ...
 */
package org.openmrs.module.knh.reporting.cohort.definition.evaluator;
...
/**
 * Patients who are missed appointment with subsequent Triage cohort definition
 */
@Handler(supports = { MissedAppointmentWithTraigeCohortDefinition.class })
public class MissedAppointmentWithTraigeCohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		MissedAppointmentWithTraigeCohortDefinition definition = (MissedAppointmentWithTraigeCohortDefinition) cohortDefinition;
		...
		String qry = "select t.patient_id\n"
		        ...
		        + "join kenyaemr_etl.etl_patient_triage tr on tr.patient_id=fup.patient_id\n"
